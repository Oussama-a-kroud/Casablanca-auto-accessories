...
export const PRODUCTS = [
  ...
  },
  {
    ...
    image: '/images/renault_460dh.png',
    secondaryImages: ['/images/tapis_3d_real.jpg', '/images/tapis_7d_list.png'],
    features: ['مفصلة بالليزر لموديل دوستر 2018-2024', 'مادة TPE/EVA الفاخرة بدون أي رائحة', 'حماية قصوى ضد السوائل والغبار'],
  ...
  // --- PEUGEOT ---
  {
    ...
    secondaryImages: ['/images/tapis_7d_list.png', '/images/tucson_470dh.png'],
  ...
  // --- MERCEDES ---
  {
    ...
    badge: 'Mercedes W203 ⭐',
    image: '/images/tapis_3d_real.jpg',
    secondaryImages: ['/images/tucson_470dh.png', '/images/tapis_7d_list.png'],
